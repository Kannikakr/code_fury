window.onload = function () {
    ...
    let categoryArray = [
      ["Natural disaster caused by shaking of the Earth's crust"],
      ["Type of storm with strong winds and heavy rainfall"],
      [" Natural disaster caused by overflowing of water"],
      ["Type of natural disaster caused by fire"],
      [" Natural disaster caused by movement of tectonic plates"],
      ["Type of storm with rotating column of air"],
      ["Natural disaster caused by drought and high temperatures"]
    ];
